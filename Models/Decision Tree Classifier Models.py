...
# 1. Decision Tree Classifier (Model 1):
...
testdf[['id', 'cuisine']].to_csv("dtc1.csv")
# Public Score (dtc1): 0.61967
...
# 2. Decision Tree Classifier (Model 2):
# Using test.json file
...
submission_df.to_csv('dtc2.csv', index=False)

# Public Score (dtc2): 0.63032
...
new_test_df[['id', 'cuisine']].to_csv("dtc3.csv")
#Accuracy (dtc3): 0.6181564245810056


# In[4]:


# 4. Decision Tree Classifier (Model 4):
# Using random 30% training data (from train.json) for testing 
# and the remaining 70% training data (from train.json) for training
...
new_test_df[['id', 'cuisine']].to_csv("dtc4.csv")

print("done")
#Accuracy (dtc4): 0.6069832402234637
